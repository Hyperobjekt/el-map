          ...
          <Paper className="data-mode__content">
            ...
            <Container className="data-mode__body">
              ...
              <FormControl>
                ...
                <FormGroup>
                  <FormControlLabel control={<Checkbox onChange={togglePptx} checked={pptx} />} label="pptx" />
                </FormGroup>
                <FormGroup>
                  <FormControlLabel control={<Checkbox onChange={togglePdf} checked={pdf} />} label="pdf" />
                </FormGroup>
                <FormGroup>
                  <FormControlLabel control={<Checkbox onChange={toggleXlsx} checked={xlsx} />} label="xlsx" />
                </FormGroup>
                {/* {} */}
                {/* for testing */}
<FormGroup>
...
<option value="local">Local</option>
            ...
            <Toolbar className="data-mode__actions">
              <Button variant="contained" color="primary" onClick={handleApply} disabled={!(pptx || pdf || xlsx)}>
                {"applyLabel"}
              </Button>
              <Button
                variant="contained"
