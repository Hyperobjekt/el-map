...
const LineChart = ({
  ...
  //   scroll: true,
  // });
  // const { containerRef, TooltipInPortal, Tooltip, TooltipWithBounds } = useTooltipInPortal({
  //   // use TooltipWithBounds
  //   detectBounds: true,
  //   // when tooltip containers are scrolled, this will correctly update the Tooltip position
  //   scroll: true,
  ...
  const handleMouseOver = (event, datum) => {
    ...
    console.log(
      coords.x,
      coords.y,
      xScale.invert(coords.x),
      yScale.invert(coords.y)
    );
  };
